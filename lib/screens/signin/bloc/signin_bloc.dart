...
class SignInBloc extends Bloc<SignInEvent, SignInState> {
  ...
  void _onTextChanged(OnTextChangedEvent event, Emitter<SignInState> emit) async {
  ...
  void _signInTapped(OnSignInTappedEvent event, Emitter<SignInState> emit) async {
  ...
  void _signUpTapped(OnSignUpTappedEvent event, Emitter<SignInState> emit) async {
